...
// PATCH /api/phed/approvals/memos/:id/approve — Stage 3 (CPO) or Stage 4 (CFO)
export async function PATCH(req: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const user = await requirePhedAccessRole(token, ['CHIEF_PEOPLE_OFFICER', 'CHIEF_FINANCE_OFFICER'])
