// src/app/api/grade-levels/[id]/steps/route.ts
...
export async function PATCH(
  ...
  try {
    ...
    const steps = await service.updateStepsConfiguration(params.id, body)
    
    return withCors(ApiResponse.success(steps, 'Step configuration updated successfully'), origin)
  } catch (error) {
