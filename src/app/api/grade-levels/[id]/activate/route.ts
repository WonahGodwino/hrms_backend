// src/app/api/grade-levels/[id]/activate/route.ts
...
export async function POST(
  ...
  try {
    ...
    const grade = await service.activateGrade(params.id)
    
    return withCors(ApiResponse.success(grade, 'Grade level activated successfully'), origin)
  } catch (error) {
