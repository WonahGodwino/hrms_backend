...
-- AddForeignKey
ALTER TABLE "benefit_allocations" ADD CONSTRAINT "benefit_allocations_allocatedBy_fkey" FOREIGN KEY ("allocatedBy") REFERENCES "staff_records"("id") ON DELETE SET NULL ON UPDATE CASCADE;
