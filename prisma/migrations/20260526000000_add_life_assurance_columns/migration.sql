...
ALTER TABLE "phed_staff"
  ADD COLUMN "hasLifeAssurance"    BOOLEAN      NOT NULL DEFAULT false,
  ADD COLUMN "lifeAssuranceAmount" DECIMAL(18,2);
...
ALTER TABLE "phed_computed_payrolls"
  ADD COLUMN "lifeAssuranceAmount" DECIMAL(18,2) NOT NULL DEFAULT 0;
